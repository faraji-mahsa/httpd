...
mod_socache_dc.la: mod_socache_dc.slo
	$(SH_LINK) -rpath $(libexecdir) -module -avoid-version  mod_socache_dc.lo $(MOD_SOCACHE_DC_LDADD)
DISTCLEAN_TARGETS = modules.mk
static = 
shared =  mod_file_cache.la mod_cache.la mod_cache_disk.la mod_cache_socache.la mod_socache_shmcb.la mod_socache_dbm.la mod_socache_memcache.la mod_socache_dc.la
